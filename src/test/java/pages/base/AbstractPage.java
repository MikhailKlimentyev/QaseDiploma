...
public abstract class AbstractPage {
    ...
    public boolean isElementDisplayed(By locator) {
        return new ElementUtils().findVisibleElement(locator, TIME_OUT).isDisplayed();
    }

    public String getTextOfElement(By locator) {
        log.debug(String.format("Getting text for element with locator '%s'", locator));
        return new ElementUtils().findVisibleElement(locator, TIME_OUT).getText();
    }
}
